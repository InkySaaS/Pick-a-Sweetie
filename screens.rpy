...
init offset = -1
default player_name = "Hikari"
default player_pronouns = "ele/dele"
...
style scrollbar:
    ...
    base_bar Frame("gui/scrollbar/horizontal_bar.png", gui.scrollbar_borders, tile=gui.scrollbar_tile)
...
style vslider:
    ...
    base_bar Frame("gui/slider/vertical_bar.png", gui.vslider_borders, tile=gui.slider_tile)
...
screen choice(items):
    ...
    vbox:
        for i in items:
            textbutton i.caption action [Function(narrator.add_history, kind="adv", who=[player_name], what=i.caption), i.action]
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Novo jogo") action Show("name_input")
        ...
        textbutton _("Créditos") action ShowMenu("about")
            ...
            #textbutton _("Finais") action ShowMenu("finais")
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                xalign 0.5
                textbutton "Ele/Dele":
                    action SetVariable("player_pronouns", "ele/dele")
                    style "radio_button"

                textbutton "Ela/Dela":
                    action SetVariable("player_pronouns", "ela/dela")
                    style "radio_button"

            textbutton "OK":
                xalign 0.5

                action [Hide("name_input"), Start()]
...
screen main_menu():
    ...
    fixed:
        ...
        if main_menu:
            ...
            #textbutton _("Novo jogo") action Show("name_input")
            imagebutton auto "gui/start_pt_%s.png" xpos 807 ypos 519 focus_mask True action Show("name_input")
        ...
        imagebutton auto "gui/saves_pt_%s.png" xpos 754 ypos 628 focus_mask True action ShowMenu("load")

        imagebutton auto "gui/options_pt_%s.png" xpos 837 ypos 734 focus_mask True action ShowMenu("preferences")
        ...
        imagebutton auto "gui/credits_pt_%s.png" xpos 821 ypos 841 focus_mask True action ShowMenu("about")
        ...
        if renpy.variant("pc"):
            ...
            ## O botão Sair é proibido no iOS e desnecessário no Android e na
            ## Web.
            imagebutton auto "gui/exit_pt_%s.png" xpos 890 ypos 955 focus_mask True action Quit(confirm=not main_menu)
...
screen about():
    ...
    use game_menu(_("Sobre"), scroll="viewport"):
        ...
        vbox:
            ...
            label "História"
            text _("Inky S. Artz\n")
            text _("rottengirlaesthetic\n")

            label "Sprites de personagem"
            text _("Inky S. Artz\n")
            ...
            label "Música por"
            text _("FulminisIctus\n")

            label "SFX por"
            text _("FulminisIctus\n")
            text _("freesound_community\n")
            
            label "Agradecimentos especiais"
            text _("Raineyellow\n")
            text _("Yuri :3\n")
            text _("Lennom\n")
