...
################################################################################
init python:
    config.font_replacement_map[("fonts/Amaranth-Regular.ttf", False, True)] = ("fonts/Amaranth-Italic.ttf", False, False)
    config.font_replacement_map[("fonts/Amaranth-Regular.ttf", True, False)] = ("fonts/Amaranth-Bold.ttf", False, False)
    config.font_replacement_map[("fonts/Amaranth-Regular.ttf", True, True)]  = ("fonts/Amaranth-BoldItalic.ttf", False, False)
...
define gui.insensitive_color = '#261913'
...
## imagem de barra.
define gui.muted_color = '#79503C'
define gui.hover_muted_color = '#FFD4AA'

## As cores usadas para o diálogo e o texto da opção de menu.
define gui.text_color = '#ffffff'
define gui.interface_text_color = '#ffffff'
define gui.name_text_color = '#79503C'

## Fontes e tamanhos de fonte ##################################################

## A fonte usada para o texto do jogo.
define gui.text_font = "fonts/Amaranth-Regular.ttf"

## A fonte usada para os nomes dos caracteres.
define gui.name_text_font = "fonts/Coiny-Regular.ttf"

## A fonte usada para o texto fora do jogo.

define gui.interface_text_font = "fonts/Amaranth-Regular.ttf"
...
define gui.main_menu_background = Movie(play="gui/main_anim.webm", channel="main_menu")
define gui.game_menu_background = Movie(play="gui/menu_anim.webm", channel="game_menu")
...
define gui.choice_button_text_idle_color = '#79503C'
define gui.choice_button_text_hover_color = "#ffffff"
define gui.choice_button_text_insensitive_color = '#261913'
